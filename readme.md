# FTE enginesimulator Dev 3.x.x.
過去に使っていたExcelデータのフローの改良及び，データ出力をおこなってくれるソフトです．

このBranchはDev用のBranchです．

(ここのdevはシルバーウイーク中にデバッグを行い，mainに統合し，2.0.0 alphaリリース予定．)
...
注意点
- ファイル名は拡張子まで入力する．
- ほとんどの変数に対して値の型チェックを行っていないので，入力の妥当性には注意する．


# Reference
全部書くと多いので，内容の被りが少ない主要なものを書いています．
