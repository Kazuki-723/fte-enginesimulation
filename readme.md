...
2026年7月時点で最新の環境を自力で組んで実行するとflet側の問題でGUIが何も表示しなくなるので，GUIの場合はuvから必須．
CLIは適当な環境でも動作確認済み．
...
ct-cea-developで，NASACEAをクビにして，自作のCEAの組み込みを作成中

一応組み込みは終わったけど，実行速度が終わっているのと結果比較とデバッグはまだ終わってないのでリリースは後ほど
